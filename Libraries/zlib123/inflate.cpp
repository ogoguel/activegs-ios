...
/*
   ...
   fixed code decoding.  Normally _this returns fixed tables from inffixed.h.
   If BUILDFIXED is defined, then instead _this routine builds the tables the
...
/*
   ...
   can simply call makefixed to do _this:
...
void makefixed()
{
    ...
    puts("     */");
    puts("");
    puts("    /* WARNING: _this file should *not* be used by applications.");
    puts("       It is part of the implementation of _this library and is");
...
/*
   ...
   when a window is already in use, or when output has been written during _this
...
/*
   ...
   In _this implementation, the flush parameter of inflate() only affects the
